...
--     tuji odsotnosti, je zapisana v tabeli nadomescanja - sicer bi bil
--     nosilec na njej vsak dan (glej supabase/nzv-lastne-enote.sql).
...
values
  ...
  ('ARNEŽ GREGA', 'ARN', '1092', 'C', 'C', 27, true, null, false, null, null, null, 'LUNAR MATEJA', 'ob odsotnosti (LD, BS) nadomeščanje Lunar Mateja'),
  ...
  ('LELIČ DIJANA', 'LEL', '1090', 'E2', 'E2', 20, false, null, false, null, null, null, 'MAGLIĆ ALEKSANDER', 'ob odsotnosti (LD, BS) nadomeščanje Aleksander Maglić'),
  ('LUNAR MATEJA', 'LUN', '844', 'B', 'B', 28, true, null, false, null, null, null, 'ARNEŽ GREGA', 'ob odsotnosti (LD, BS) nadomeščanje Arnež Grega'),
  ('MAGLIĆ ALEKSANDER', 'MAG', '1001', 'E1', 'E1', 18, false, null, false, null, null, null, 'LELIČ DIJANA', 'ob odsotnosti (LD, BS) nadomeščanje Dijana Lelić'),
  ('MAVRI TRATNIK MAGDALENA', 'TRA', '833', 'B1B2', 'B1', 29, true, null, false, null, null, null, 'ŠUBIC PETRA', 'ob odsotnosti (LD, BS) nadomeščanje Šubic Petra'),
  ...
  ('ŠUBIC PETRA', 'ŠUB', '905', 'B1B2', 'B1', 28, true, null, false, null, null, null, 'MAVRI TRATNIK MAGDALENA', 'ob odsotnosti (LD, BS) Magdalena Mavri Tratnik'),
