...
-- Vrsta za sinhronizacijo z Google Sheets in nerešene napake sinhronizacije
-- (glej supabase/sheets-sinhronizacija.sql, kjer je isto z razlagami).
-- Tudi to stoji na KONCU datoteke, ker se sklicuje na sheet_connections
-- tik nad tem. Sprožilec na razporedu je brez učinka, dokler ni nobene
-- vklopljene povezave - baza, postavljena po tej datoteki, torej deluje
-- natanko tako kot doslej, aplikacija pa tabel ne pogreša (Generator ju
-- bere v razdelkih "Povezani Google listi" in "Nerešene napake
-- sinhronizacije").
