  ...
  function preveriPravila(vnosi, pravila) {
    ...
    Object.keys(poOsebi).forEach(function (oseba) {
      ...
      if (p.zahtevajProstDanNaTeden && delovni.length) {
        var meja = p.maxZaporednihDelovnihDni;
        var zacetekNiza = null, zadnjiVNizu = null, dolzina = 0;
        var zakljuciNiz = function () {
          ...
          krsitve.push({
            ...
            oseba: oseba, datum: dodajDni(zacetekNiza, meja), vrsta: "prostDan",
            resnost: "kriticno",
